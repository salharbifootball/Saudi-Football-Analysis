...
<div dir="rtl" style='background-color:#1a2a3a; padding:15px; border-radius:10px; font-size:16px; color:#f5f5f5; text-align: right;'>
 ...
 <strong>تحليل بصري للمباراة بين الفريقي:</strong>
<ul>
<li> <strong>خريطة الإحصائيات العامة:</strong> نظرة سريعة على مؤشرات مثل الاستحواذ، التمرير، التدخلات، الضغط، والكرات الهوائية.</li>
<li> <strong>خريطة التسديدات:</strong> توضّح مواقع التسديدات الناجحة والمهدرة، والفرص الخطيرة حسب كل فريق.</li>
<li> <strong>خريطة المرمى:</strong> تحليل مرئي لجودة الفرص أمام المرمى ومدى فاعلية التسديدات.</li>
<li> <strong>تحليل الزخم:</strong> عرض لفترات السيطرة الهجومية لكل فريق طوال مجريات اللقاء.</li>
</ul>
</div>
""", unsafe_allow_html=True)
